...
function displayProduct() {
  ...
  productsData.forEach((product) => {
    ...
    productCard.append(image, name, price, rating, addToCart);
...
document.getElementById("sortByPrice").addEventListener("change", () => {
  let sortType = document.getElementById("sortByPrice").value;
...
document.getElementById("sortByRating").addEventListener("change", ()=>{
    let sortType = document.getElementById("sortByRating").value 
    productsData.sort(function (a, b) {
        if ((sortType = "lowToHigh")) {
